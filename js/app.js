...
if ('storage' in navigator && 'estimate' in navigator.storage) {
  navigator.storage.estimate()
    .then(estimate => {
      ...
      document.getElementById('percent').innerHTML = (estimate.usage * 100 / estimate.quota).toFixed(6);
    });
}
...
//_____________________________ END OF QUOTA _________________________________________________
//_____________________________ Start OF Offline Storage _____________________________________
...
//_____________________________ END OF Offline Storage_________________________________________________
//_____________________________ Start OF getFile _____________________________________
